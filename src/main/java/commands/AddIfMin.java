...
public class AddIfMin extends Command implements Serializable {
    ...
    public AddIfMin(Console console, Boolean needCommandManager, Boolean needCollectionManager, Boolean isServerMethod) {
        super("add_if_min", "Add element if its value less than the least element of collection", needCommandManager, needCollectionManager, isServerMethod);

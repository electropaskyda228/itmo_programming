...
public class Movie extends Element implements Validatable, Cloneable, Serializable {
    ...
    public int compareTo(Element element) {
        return Comparator.comparing(Movie::getMpaaRating, (s1, s2) -> MpaaRating.compareTo(s1, s2)).thenComparing(Movie::getOscarsCount).thenComparing(Movie::getGoldenPalmCount)

...
public class CollectionManager {
    private final TreeSet<Movie> brotherhood = new TreeSet<>();
    ...
    public boolean init() {
        brotherhood.clear();
        movieMap.clear();
        DumpManager.getInstance().readCollection(brotherhood);
    ...
    public boolean saveCollection() {
        if (!DumpManager.getInstance().writeCollectionToCSV(brotherhood)) return false;
